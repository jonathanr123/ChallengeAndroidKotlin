...
class MovieAdapter(private val images: MutableList<ResultResponse>) : RecyclerView.Adapter<MovieViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        holder.bind("https://image.tmdb.org/t/p/w500_and_h282_face"+item.poster_path, item.title, item.id)
